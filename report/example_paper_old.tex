...
\textbf{Data scarcity.} As stated on Section \ref{sec:datasets}, Qwen3.5 models are trained to refuse harmful instructions, so the GCG attack was necessary to generate accepted answers. Due to time constraints, our accepted harmful bucket only contained 17 data points on the non-thinking generation. 
