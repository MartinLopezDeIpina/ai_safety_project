...
\subsection{Harmful and refusal direction causal separation}
\label{sec:causal-separation}
...
\caption{Layer-wise refusal elicitation after steering along the estimated harmfulness and refusal directions.}
\label{fig:fig4}
\end{figure}
