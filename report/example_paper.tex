...
\caption{Refusal rate on harmless instructions after steering with the harmful (fh_s1) and refusal (refusal_s20) directions. random_hf_s1 represents a baseline random vector with the harmful vector's magnitude, and random_refusal_s20 represents a baseline random vector with the refusal vector's magnitude.}
=======
...
>>>>>>> d29c5b8142a36c26dffb820e10733daf3c78e6ed
\label{fig:fig4}
\end{figure}
