...
We test our $t_{\text{post-inst}}$ and gen1 token activations to check whether we can elicit refusal.
...
The green and purple curves curves show the refusal rates under additive steering in the random directions $\tilde{v}_l^\textup{harmful}$ and $\tilde{v}_l^\textup{refuse}$, respectively.
