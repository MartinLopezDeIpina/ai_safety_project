...
\caption{The orange and blue curves show the refusal rates under additive steering in the harmfulness and refusal directions.
...
The steering coefficient is set to $4$ in all cases, and the thinking mode is disabled.}
\label{fig:fig4}
\end{figure}
