...
\caption{The orange and blue curves show the refusal rates under additive steering in the harmfulness direction (orange curve) and refusal direction (blue curve).
In addition, we randomly rotated the steering vectors $v^\textup{harmful}_l$ and $v^\textup{refuse}_l$ to produce two random steering directions.
The results of random steering are given by the green and purple curves.
The steering coefficient is set to $c = 4$ in all cases, and the thinking mode is disabled.}
\label{fig:fig4}
\end{figure}
...
The steering coefficient is set to $c = 2$ in all cases.
